...
(function main() {
  ...
  var pixelatedStyle =
    "image-rendering:crisp-edges; image-rendering:-moz-crisp-edges; image-rendering:pixelated; image-rendering: -o-crisp-edges; -ms-interpolation-mode: nearest-neighbor";
  if (displayPixelated) {
  ...
  jQuery("#mid").bind("mousewheel", zoom).bind("dblclick", reset);
  jQuery("#right").bind("mousewheel", zoom).bind("dblclick", reset);
...
function downloadImageFromUrl(url, div, image) {
  // Remove old stuff
  ...
  if (image.dom !== null) {
    ...
    fileReader.onload = function (event) {
      ...
      if (image.file.type.startsWith("image")) {
        ...
        image.dom.addEventListener(
          "loadedmetadata",
          function (e) {
            (image.width = this.videoWidth), (image.height = this.videoHeight);
            details.innerHTML =
              details.innerHTML +
              "<br>\
						Dimension: " +
